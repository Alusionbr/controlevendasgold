(function () {
  ...
  function openClientEditor(clientId, focusEdit = false) {
    ...
    nativeDialog.id = 'clientEditor';
    nativeDialog.className = 'product-editor-dialog client-editor-dialog';
    nativeDialog.innerHTML = `
        ...
        <div class="two-columns client-editor-columns">
          <section class="panel-card">
            ...
            <form id="clientEditForm" class="stack-form">
              ...
              <label>Tipo<select name="type"><option value="cliente" ${client.type === 'cliente' ? 'selected' : ''}>Cliente</option><option value="consignado" ${client.type === 'consignado' ? 'selected' : ''}>Consignado</option><option value="ambos" ${client.type === 'ambos' ? 'selected' : ''}>Ambos</option></select></label>
...
,'
  ...
  init();
    ...
    nativeDialog.addEventListener('close', () => nativeDialog.remove());
    document.body.appendChild(nativeDialog);
    if (typeof nativeDialog.showModal === 'function') nativeDialog.showModal(); else nativeDialog.setAttribute('open', '');
    if (focusEdit) nativeDialog.querySelector('[name="name"]')?.focus();
  }
